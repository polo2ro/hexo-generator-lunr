...
module.exports = function(locals){
	...
	lunr.Pipeline.registerFunction(ASCIIFolder.fold, 'foldToAscii');
	...
	for(var yearKey in res){
		...
		searchIdx.pipeline.before(
			lunr.Pipeline.registeredFunctions.trimmer,
			lunr.Pipeline.registeredFunctions.foldToAscii
		);
